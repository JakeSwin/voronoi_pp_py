...
def _lbg_jit(jfa_map: Array, data: Array, padded_seeds: Array, num_seeds: int):
    ...
    weights_sum = jnp.bincount(flat_index_map, weights=flat_weights, length=MAX_CELLS)
